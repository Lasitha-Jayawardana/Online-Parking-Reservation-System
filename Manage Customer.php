...
<div class="page-wrapper chiller-theme mt-5">
                        ...
                        <li class="header-menu">
                         ...
                         <li >
                            ...
                            <a href="#">
                                ...
                                <span  style="font-size: 17px;color: white;">Manage Customer</span>
   ...
   <h4 class="text-center mt-3 mb-3 ">Manage Customer</h4>
    ...
    $query= "SELECT * FROM user WHERE Super_ID = 1000 ORDER BY NIC ASC ;";
           ...
           foreach($v_no as $n){
            $list.= ''.$n.'<br>';
                          ...
                          echo '</td>
                           ...
                           <button type="button" onclick="showmodel(this)" style="overflow: visible;" class="btn btn-danger btn-round blinkhover pt-1" data-toggle="tooltip" data-placement="top" title="Remove Customer">
  ...
  <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
          <div class="modal-header"> <h4 class="modal-title custom_align" id="Heading">Delete this entry</h4>
       ...
       <div class="alert alert-danger"><span class="fas fa-exclamation-triangle"></span> Are you sure you want to delete this Record?</div>
        ...
        <button  onclick="remove()" type="button" class="btn btn-success" ><span id="del" class="fas fa-check"></span> Yes</button>
